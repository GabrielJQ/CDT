        ...
        <div class="bg-white rounded-xl shadow p-4 mb-4">
            <form method="GET" action="{{ url('/informacion-tiendas') }}" class="flex flex-wrap items-end gap-3">
                ...
                <div class="flex gap-2">
                    ...
                    <a href="{{ url('/informacion-tiendas') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-700 px-4 py-2 rounded-lg text-sm font-semibold transition inline-block">Limpiar</a>
                </div>
            </form>
        </div>
