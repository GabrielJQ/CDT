...
<head>
    ...
    <title>Sesión expirada — Dashboard CDT</title>
...
<body class="bg-gray-100 dark:bg-gray-900 min-h-screen flex items-center justify-center p-6">
    <div class="text-center max-w-md">
        ...
        <h1 class="text-5xl font-bold text-gray-800 dark:text-gray-100 mb-2">419</h1>
        <p class="text-lg text-gray-500 dark:text-gray-400 mb-6">Sesión expirada</p>
        <p class="text-sm text-gray-400 dark:text-gray-500 mb-8">Tu sesión ha expirado. Intenta recargar la página.</p>
