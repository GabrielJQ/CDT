...
<head>
    ...
    <title>Error interno — Dashboard CDT</title>
...
<body class="bg-gray-100 dark:bg-gray-900 min-h-screen flex items-center justify-center p-6">
    <div class="text-center max-w-md">
        ...
        <h1 class="text-5xl font-bold text-gray-800 dark:text-gray-100 mb-2">500</h1>
        <p class="text-lg text-gray-500 dark:text-gray-400 mb-6">Error interno del servidor</p>
        <p class="text-sm text-gray-400 dark:text-gray-500 mb-8">Ocurrió un error inesperado. Intenta de nuevo más tarde.</p>
