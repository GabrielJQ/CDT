...
@push('head')
<style>
    #conn-table td, #conn-table th { white-space: nowrap; padding: 0.4rem 0.6rem; font-size: 0.8rem; }
        ...
        <div class="bg-white rounded-xl shadow p-4 mb-4">
            <form method="GET" action="/conectividad" class="flex flex-wrap items-end gap-3">
                ...
                <div class="flex gap-2">
                    ...
                    <a href="/conectividad" class="bg-gray-200 hover:bg-gray-300 text-gray-700 px-4 py-2 rounded-lg text-sm font-semibold transition inline-block">Limpiar</a>
                </div>
            </form>
        </div>
